const CACHE='espa-v3.0.0';
const ASSETS=['./','index.html','styles.css','app.js','reader.js','config.js','assistants.js','technical.js','router-patch.js','manifest.webmanifest','data/content.json'];
