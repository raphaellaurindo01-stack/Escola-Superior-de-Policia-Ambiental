const CACHE='espa-v3.3.0-dev';
const ASSETS=['./','index.html','styles.css','app.js','reader.js','config.js','assistants.js','technical.js','platform-api.js','platform-ui.js','router-patch.js','manifest.webmanifest','data/content.json'];
